      ...
      <CardContent className="space-y-6">
        ...
        <div className="p-4 bg-muted/50 rounded-lg">
          ...
          <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
            <li>
              <strong>Export:</strong> Click "Export All Data" to download a JSON backup file
            </li>
            <li>
              <strong>Transfer:</strong> Copy the JSON file to your other device/browser
            </li>
            <li>
